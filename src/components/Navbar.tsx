  ...
  return (
    <nav className='flex items-center justify-between flex-wrap bg-orange-500 p-6'>
        ...
        <div className='block'>
            <button 
                onClick={dropDown}
                className='flex items-center px-3 py-2 text-orange-200
                border rounded border-orange-400 hover:text-white hover:border-white'
                >
        ...
        { isVisible ? ( 
            <div className='w-full block flex-grow items-center'>
                <div className='text-sm lg:flex-grow'>
                    <Button className='p-3 m-5 bg-orange-400 justify-center rounded'>
                        <div>
                            <Link to='/' onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block lg:mt-0
                            text-orange-200 hover:text-white mr-4'>
                                Home
                            </Link>
                        </div>
                    </Button>
                    ...
                    </Button>
                    {
                        ...
                        <Button className='p-3 m-5 bg-orange-400 justify-center'>
                            <div>
                                ...
                                lg:inline-block lg:mt-0 text-orange-200 hover:text-white'>
                                    Login
                                </Link>
                            </div>
                        </Button>
